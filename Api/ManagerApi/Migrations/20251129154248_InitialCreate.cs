        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChangeHistories_Users_ChangedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GeneralAttachments_Users_UploadedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AssignedToId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FixedInTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bugs_Tasks_FixedInTaskId",
                        column: x => x.FixedInTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bugs_FixedInTaskId",
                table: "Bugs",
                column: "FixedInTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BugTags_TagId",
                table: "BugTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_ChangeHistories_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneralAttachments_UploadedById",
                table: "GeneralAttachments",
                column: "UploadedById");
